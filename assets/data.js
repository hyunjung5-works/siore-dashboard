...
const AMZ_PLAN = {
  ...
  // 월 마케팅(광고) 예산 (원)  ※ 유가협업·시딩·약사님·외부광고·Amazon SP 포함
  adBudgetKRW:  [0, 0, 0, 3750000, 42510000, 57460000, 62000000, 65000000, 83000000, 108000000, 120000000, 108000000],
  totalRevKRW: 1509131660,
  totalAdKRW:  649720000,
  // 마케팅 예산 카테고리 [항목, 연간예산(원), 비중]
  mktCategories: [
    ['유가협업',   335720000, 51.67],
    ['시딩',       106000000, 16.31],
    ['약사님',      56000000,  8.62],
    ['외부광고',    95000000, 14.62],
    ['Amazon SP',  57000000,  8.77],
  ],
};
