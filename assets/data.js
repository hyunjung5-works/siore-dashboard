...
const DOM_FORECAST = {
  ...
  items: {
    'NMN 하이드로 캡슐 클렌징 밀크': { demand:29,  draw:29,  runwayM:32.0, short:null,  order:0     },
    'NMN 프레쉬 버블 토너':          { demand:256, draw:339, runwayM:16.5, short:null,  order:0     },
    'NMN 인텐시브 세럼':             { demand:384, draw:511, runwayM:2.9,  short:'9월',  order:21362 },
    'NMN 하이드레이팅 수딩 크림':     { demand:32,  draw:32,  runwayM:10.0, short:null,  order:0     },
    'NMN 딥 글로우 리치 크림':       { demand:263, draw:263, runwayM:28.2, short:'10월', order:3682  },
    '데일리 릴리프 에센스 토너':      { demand:31,  draw:31,  runwayM:69.4, short:null,  order:0     },
    '데일리 릴리프 리페어 앰플':      { demand:34,  draw:34,  runwayM:47.4, short:null,  order:0     },
    '데일리 릴리프 카밍 수딩 젤':     { demand:259, draw:259, runwayM:19.2, short:null,  order:0     },
    '데일리 릴리프 컴포트 크림':      { demand:73,  draw:73,  runwayM:26.3, short:null,  order:0     },
  },
};
...
const INFLUENCER = {
  ...
  seeding: {
    ...
    budgetKRW: 307000000,
    qty: 3536,   // 무가계획 건수 (코이2400+지퓨처스1000+내부136)
    // 수량 = 무가계획 건수 (재고 수량 아님)
    vendors: [
      ['코이',    '무가 시딩', 172000000, 2400],
...
/* ==========================================================
   광고 채널 실집행 (시트 [2026 광고데이터] · 아마존/메타 탭)
   - 6/1 ~ 7/14 누적 · 자동갱신 snapshot.js가 아닌 여기 권위 보관
   channels: [매체, 노출, 클릭, 지출$, 구매, 전환매출$, ROAS%]
   ========================================================== */
const ADS = {
  asOf: '2026 6/1~7/14',
  channels: [
    ['Amazon SP', 1267762,  6717, 15417.9, 866, 25951.6, 168.32],
    ['Meta',      1280045, 59733, 14834.5,  27,   764.7,   5.15],
  ],
  // 월별 광고비($) [아마존, 메타]
  monthly: {
    '2026-06': { amazon: 6333.2, meta: 7900.6 },
    '2026-07': { amazon: 9084.7, meta: 6933.9 },
  },
  get totSpend(){ return this.channels.reduce((a,c)=>a+c[3],0); },
  get totRev(){ return this.channels.reduce((a,c)=>a+c[5],0); },
  get totBuy(){ return this.channels.reduce((a,c)=>a+c[4],0); },
};
